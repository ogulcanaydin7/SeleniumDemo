...
public class SiteTests {
    ...
    void hepsiburadaLoginTesti(){
        ...
        girisYapSayfası.alanaYaziYaz(girisYapSayfası.emailAdresi, "ogulcanaydn@hotmail.com");
        //driver.findElement(By.id("txtUserName")).sendKeys("ogulcanaydn@hotmail.com");

        anaSayfa.elementGörününeKadarBekle(girisYapSayfası.parola);
        girisYapSayfası.alanaYaziYaz(girisYapSayfası.parola, "Ogulcan98");
